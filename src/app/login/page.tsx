...
export default function LoginPage() {
  return (
    <div className="h-screen w-screen flex overflow-hidden bg-[#080400]">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(160deg, #080400 0%, #120600 40%, #0d0500 70%, #080400 100%)",
        }}
      >
        ...
        <div className="relative z-10 w-full max-w-[400px]">
          ...
          <div className="flex items-center gap-3.5 mb-10">
            ...
            <div>
              <div className="text-white font-extrabold text-xl leading-none tracking-tight">
                eSpark <span style={{ color: "#f97316" }}>AI</span>
              </div>
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-black leading-none tracking-tight mb-3 text-white">
              ...
              <span
                ...
                style={{ backgroundImage: "linear-gradient(120deg, #f97316 0%, #fb923c 50%, #ea580c 100%)" }}
              >
                Grow faster.
              </span>
            </h1>
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 8px 48px rgba(0,0,0,0.4), 0 0 0 1px rgba(249,115,22,0.08) inset",
            }}
          >
            ...
            <div className="mt-5 pt-4 space-y-2.5" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
              {[
                ...
                { icon: <CheckCircle size={13} />, color: "#f97316", text: "Synced across all your devices" },
                { icon: <Sparkles size={13} />, color: "#fb923c", text: "Personalised AI powered by eSpark" },
          ...
          <p className="text-center text-[11px]" style={{ color: "rgba(255,255,255,0.22)" }}>
            ...
            <span className="hover:underline cursor-pointer" style={{ color: "rgba(249,115,22,0.7)" }}>Terms</span>
            {" & "}
            <span className="hover:underline cursor-pointer" style={{ color: "rgba(249,115,22,0.7)" }}>Privacy Policy</span>
            {" · eSpark AI © 2026"}
          </p>
        </div>
      </div>
